 ...
 *
 * struct trapframe is used for moving between kernel space
 * and user space, and will therefore only store 'user'
 * data and variables. Trapframes are saved and restored
 * by the _switchtosvc, do_svc, and trapret assembly
 * routines.
 *
 * @see _switchtosvc, do_svc, and trapret in exception.S
 *
